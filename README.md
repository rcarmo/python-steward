...
```bash
python3 -m steward.mcp   # or: steward-mcp
```

See [docs/protocols.md](docs/protocols.md) for configuration examples.
...
```bash
python3 -m steward.acp   # or: steward-acp
```

See [docs/protocols.md](docs/protocols.md) for full ACP feature documentation.
